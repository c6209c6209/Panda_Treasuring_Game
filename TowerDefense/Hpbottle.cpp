...
#include"Panda.hpp"
HPbottle::HPbottle(float x, float y, float w, float h, int score) :
	Treasure("play/heal bottle.png", x,y,w,h, score) {
}
void HPbottle::Update(float deltaTime) {
...
void HPbottle::OnExplode(Enemy* enemy) {
