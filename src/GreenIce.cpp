...
#include "Panda.hpp"
GreenIce::GreenIce(Engine::Point position, Engine::Point forwardDirection, float rotation, Panda* parent) :
	Ice("play/Greenice.png", 50,50, 100, 4, position, forwardDirection, rotation + ALLEGRO_PI / 2, parent) {
}
void GreenIce::Update(float deltaTime) {
...
void GreenIce::OnExplode(Enemy* enemy) {
